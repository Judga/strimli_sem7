...
with col1:
    st.image("assets/img.jpg", width=200, caption="Estudiante", output_format="JPEG")

# Columna derecha: Información del estudiante
with col2:
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Michael Steven Galvis Buritica</h3>', unsafe_allow_html=True)
